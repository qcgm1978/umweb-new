...
<head>
    ...
    <title><?php if(isset($this->title) && $this->title) echo $this->title; else echo "U美网"; ?> | U美网直播社区 - 美女主播 - 美女秀场 - 视频聊天 - 视频交友 </title>
    ...
    <div class="wrapIn">
        ...
        <div class="headerOuter">
            ...
            <div class="headerIn">
                ...
                <!--登录注册 end-->
                <!--添加到桌面-->
                <div class="AddDesktop"><a href="/desktop.php" title="">添加到桌面</a></div>
                <!--添加到桌面 end-->
            </div>
            <!--headerIn end-->
